...
class FlashcardFletApp:
    def __init__(self, page: ft.Page):
        ...
        # FIX 2: FilePicker must use on_result callback — pick_files() does NOT return files directly
...
if __name__ == "__main__":
    # FIX 7: Use absolute path for assets_dir so it always resolves correctly
    # regardless of where you run the script from.
    # Your assets folder structure should look like:
    #   assets/
    #     background_images/
