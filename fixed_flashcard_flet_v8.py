...
class FlashcardFletApp:
    ...
    async def play_loaded_music(self, target: str) -> bool:
        ...
        if getattr(self.bgm, "src", None) != wanted_src:
            return False
    ...
    async def switch_music_once(self, target: str, force: bool = False) -> bool:
        ...
        try:
            ...
            if src_changed:
                ...
                # Force the player to drop the previous media before assigning the new one.
                try:
                    self.bgm.src = None
                    self.page.update()
                except Exception:
                ...
                # Wait for on_bgm_loaded() to start the newly loaded track.
                return False
