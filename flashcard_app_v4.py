...
class FlashcardFletApp:
    def __init__(self, page: ft.Page):
        ...
        # FIX 2: FilePicker on_result must be assigned as an attribute AFTER creation
        # (Flet 0.80+ does not accept on_result in the constructor)
    ...
    def main_button(self, text, on_click):
        # FIX 4: ft.Button does not exist in Flet — use ft.ElevatedButton
